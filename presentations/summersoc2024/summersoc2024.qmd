...
::: {.column width="50%"}
**Edge computing:** Placing of computational
resources close to end-users
...
::: {.column width="50%"} 
![Similar **infrastructures**, **optimization goals**, and **application placement** operations.
](images/problem-statement-visualization.png)
...
User story: *"I want a tool that supports real-world experiments of **creating** the infrastructure, **operate** my applications, **monitors** devices and applications, and helps with **evaluation** and **documentation** for my scientific publication."*
...
Extracted from 27 peer-reviewed service placement solutions^[https://spboehm.github.io/pulceo-misc/]

![](images/domain-model-uml.svg)

## PULCEO's Architecture

- Decoupled orchestration with RESTful HTTP API exposed by API Gateway
- Microservice architecture aligned to a scientific meta-study^[B. Costa, J. Bachiega, L. R. de Carvalho, and A. P. F. Araujo, “Orchestration in Fog Computing: A Comprehensive Survey,” ACM Comput. Surv., vol. 55, no. 2, pp. 1–34, Feb. 2023, doi: 10.1145/3486221.]
...
::: {.column width="40%"}
- Example: Placement of edge-iot-simulator (eis)^[https://github.com/spboehm/edge-iot-simulator] on node fog1
...
*If needed, issue further Metrics Requests to monitor the placed Applications.*

# Evaluation

## Overview API Requests

41 requests have been performed tol holistically manage the cloud-edge environment
...
**Conceptual** and **prototypical research efforts** (Sophos, Fluidity, ACOA, etc.)
...
- Strong **scientific** and **industrial** foundation
  - Orchestration architecture based on a scientific meta-study^[B. Costa, J. Bachiega, L. R. de Carvalho, and A. P. F. Araujo, “Orchestration in Fog Computing: A Comprehensive Survey,” ACM Comput. Surv., vol. 55, no. 2, pp. 1–34, Feb. 2023, doi: 10.1145/3486221.]
  - Feature Engineering based on scientific, peer-reviewed service placement publications^[https://spboehm.github.io/pulceo-misc/]
  - Implementation following an industry standard (OpenFog RA)^[S. Bohm and G. Wirtz, “PULCEO - A Novel Architecture for Universal and Lightweight Cloud-Edge Orchestration,” in 2023 IEEE International Conference on Service-Oriented System Engineering (SOSE), Athens, Greece: IEEE, Jul. 2023, pp. 37–47.
]

**Limitations**: Only one representational architecture implemented with stable network conditions

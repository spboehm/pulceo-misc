...
::: {.column width="50%"} 
Many solutions exist for **service placement**, **offloading**, **scaling** in cloud-edge orchestration
...
because of **custom** an **proprietary** implementations and missing **real-world experiments** 
:::

::: {.column width="50%"} 
![](images/problem-statement-visualization.png)
Cloud-Edge Architectures are using similar **infrastructures**, **optimization goals**, and **application placement** operations  
<br/>
35% of 98 experiments used proprietarycomponents and test beds^[S. Smolka and Z. Á. Mann, “Evaluation of fog application
placement algorithms: a survey,” Computing, vol. 104, no. 6, 2022]
:::
...
*"I want a tool that supports real-world experiments of **creating** the infrastructure, **operate** my applications, **monitors** devices and applications, and helps with **evaluation** and **documentation** for my scientific publication."*
...
- EU Projects (Horizon Research), like CODECO, FogAtlas, SODALITE@RT, ENACT, etc. 
  ...
  - Development partly not started or abandoned

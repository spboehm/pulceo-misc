...
because of **custom** and **proprietary** implementations and missing **real-world experiments**
:::
...
Simulations are prevalent: only 19 out of 99 solutions (19%) used a small test-bed
...
- RESTful HTTP API exposed by API Gateway
...
- Focus on large-scale industry-grade projects, not scientific experiments
...
**Cloud** and **proprietary** solutions

- Rather used for static device connection and workload placement
- No advanced cloud-edge orchestration possible

## Contributions (OpenAPI specification)

- Fully documented RESTful HTTP API for universal orchestration  
- Decoupled cloud-edge orchestration and holistic cloud-edge orchestration

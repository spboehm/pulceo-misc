...
::: columns
::: {.column width="50%"}
- POST /nodes: Node connected and running PNA
- POST /applications: Node running an instance of edge-iot-simulator /applications
- Set of tasks $T$, small, medium, and large size

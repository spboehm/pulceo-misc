...
```{r metrics-directories, child = 'directories.Rmd' }
```

```{r metrics-r, include=FALSE, echo=FALSE}
...
|| ICMP_RTT_PRESENT || TCP_BW_PRESENT || UDP_BW_PRESENT || REQUESTS_PRESENT || TASKS_PRESENT) "## Metrics"`

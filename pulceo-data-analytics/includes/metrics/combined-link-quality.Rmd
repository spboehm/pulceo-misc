...
```{r metrics-combined-link-quality-include-bw, eval=(nrow(TCP_BW) > 0 && nrow(UDP_BW) > 0), child = 'includes/metrics/bw.Rmd', include=FALSE, echo=FALSE}
```
...
```{r metrics-combined-link-quality-include-icmp, eval=nrow(ICMP_RTT) > 0, child = 'includes/metrics/rtt-icmp.Rmd', include=FALSE, echo=FALSE}
```

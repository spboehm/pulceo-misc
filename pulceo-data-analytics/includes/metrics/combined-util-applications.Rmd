```{r metrics-combined-utilization-applications-load-data-set, include=FALSE, echo=FALSE}
...
```{r metrics-combined-utilization-applications-cpu-mem-util-plot, include=TRUE, echo=FALSE}
# TODO: condition

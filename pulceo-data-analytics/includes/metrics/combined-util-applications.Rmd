...
```{r metrics-combined-utilization-nodes-include-cpu-util-applications, eval=HasApplications(CPU_UTIL), child = 'includes/metrics/cpu-util-applications.Rmd', include=FALSE, echo=FALSE}
```

```{r metrics-combined-utilization-nodes-include-mem-util-applications, eval=HasApplications(MEM_UTIL), child = 'includes/metrics/mem-util-applications.Rmd', include=FALSE, echo=FALSE}
```

<!-- TODO: storage util -->

```{r metrics-combined-utilization-nodes-include-net-util-applications, eval=HasApplications(NET_UTIL), child = 'includes/metrics/net-util-applications.Rmd', include=FALSE, echo=FALSE}
```

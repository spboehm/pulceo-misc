...
```{r metrics-requests-application-response-time-summary-table, eval=nrow(REQUESTS) > 0, include=TRUE, echo=FALSE}
...
```{r metrics-requests-application-response-time-summary-bar-plot, eval=nrow(REQUESTS) > 0, include=TRUE, echo=FALSE}

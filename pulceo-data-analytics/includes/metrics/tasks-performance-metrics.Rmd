...
SaveLatexTable(throughput_df, "Task throughput", "task-throughput", "task_throughput.tex")
```
...
SaveLatexTable(arrival_rate_df, "Task arrival rate", "task-arrival-rate", "task_arrival_rate.tex")
```

...
all_task_metrics_stats <- rbind(
    ...
    offloading_time_stats,
    waiting_time_on_pna_stats,
    waiting_time_total_stats,
    processing_time_stats,
    completion_time_stats
)
CreateScrollableTable(all_task_metrics_stats)
SaveLatexTableForTaskMetrics(all_task_metrics_stats, "Task metric statistics for different batch sizes in seconds (s)", "task-metrics-statistics", "task_metrics_statistics.tex")
```

...
boxplot_waiting_total <- ggplot(waiting_time_total_df, aes(x = batchSize, y = time)) +
    geom_boxplot(fill = "skyblue", color = "darkblue") +
    labs(title = "Waiting Time (Total)", y = "Time (s)", x = "Batch Size") +
    theme_minimal()

boxplot_waiting_psm <- ggplot(waiting_time_on_psm_df, aes(x = batchSize, y = time)) +
    geom_boxplot(fill = "skyblue", color = "darkblue") +
    labs(title = "Waiting Time (PSM)", y = "Time (s)", x = "Batch Size") +
    theme_minimal()

boxplot_waiting_pna <- ggplot(waiting_time_on_pna_df, aes(x = batchSize, y = time)) +
    geom_boxplot(fill = "skyblue", color = "darkblue") +
    labs(title = "Waiting Time (PNA)", y = "Time (s)", x = "Batch Size") +
    theme_minimal()

boxplot_scheduling <- ggplot(scheduling_time_df, aes(x = batchSize, y = time)) +
    geom_boxplot(fill = "skyblue", color = "darkblue") +
    labs(title = "Offloading Time", y = "Time (s)", x = "Batch Size") +
    theme_minimal()

boxplot_processing <- ggplot(processing_time_df, aes(x = batchSize, y = time)) +
    geom_boxplot(fill = "skyblue", color = "darkblue") +
    labs(title = "Processing Time", y = "Time (s)", x = "Batch Size") +
    theme_minimal()

boxplot_completion <- ggplot(completion_time_df, aes(x = batchSize, y = time)) +
    geom_boxplot(fill = "skyblue", color = "darkblue") +

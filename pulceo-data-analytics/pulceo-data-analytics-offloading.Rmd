...
```{r}
average_troughput_by_batch_size <- CalculateThroughput(completion_time_df, batchSize)
```
...
```{r}
average_arrival_rate_by_batchSize <- CalculateTaskArrivalRate(tasks, batchSize)
```

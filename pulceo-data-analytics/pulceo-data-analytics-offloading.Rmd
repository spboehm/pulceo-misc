...
waiting_time_on_psm_stats <- CalculateWaitingTimeStats(waiting_time_on_psm_df, start_status = "NEW", end_status = "RUNNING", "Waiting Time (PSM)")
```
...
waiting_time_on_psm_table <- waiting_time_on_psm_stats %>%
    ...
    kable(
        ...
        booktabs = TRUE,
        escape = FALSE,
        caption = "Task Metrics Statistics",
        col.names = c("Task metric", "S1", "S2", "200", "400", "600", "800"),

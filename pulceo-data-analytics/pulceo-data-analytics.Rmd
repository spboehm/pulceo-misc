...
names(COMBINED_UDP_JITTER_PACKAGE_LOSS) <- c("Source", "Destination", "Min (TCP)" , "Mean (TCP)", "Max (TCP)", "Med (TCP)", "SD (TCP)", "Min (UDP)" , "Mean (UDP)", "Max (UDP)", "Med (UDP)", "SD (UDP)")
